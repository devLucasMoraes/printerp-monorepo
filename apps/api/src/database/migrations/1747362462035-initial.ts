...
export class Initial1747362462035 implements MigrationInterface {
  name = 'Initial1747362462035'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role" "public"."members_role_enum" NOT NULL DEFAULT 'MEMBER', "organization_id" uuid NOT NULL, "user_id" uuid NOT NULL, "organizationId" uuid, "userId" uuid, CONSTRAINT "UQ_7ad90bd282e1be5fb2f44f41f62" UNIQUE ("organization_id", "user_id"), CONSTRAINT "PK_28b53062261b996d9c99fa12404" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."tokens_type_enum" AS ENUM('PASSWORD_RECOVER')`,
    )
    await queryRunner.query(
      `CREATE TABLE "tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."tokens_type_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "organization_id" uuid, "userId" uuid, "organizationId" uuid, CONSTRAINT "PK_3001e89ada36263dabf1fb6210a" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider" "public"."accounts_provider_enum" NOT NULL, "provider_account_id" character varying(255) NOT NULL, "user_id" uuid NOT NULL, "organization_id" uuid, "userId" uuid, "organizationId" uuid, CONSTRAINT "UQ_b0a347a4e389f28de99d982b103" UNIQUE ("provider_account_id"), CONSTRAINT "UQ_2ba6fba109b54b0810d9be93a02" UNIQUE ("provider", "user_id"), CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "username" character varying(255) NOT NULL, "email" character varying(255), "password" character varying(255) NOT NULL, "avatar_url" character varying(255), "role" character varying(255) NOT NULL DEFAULT 'user', "active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "organization_id" uuid, "organizationId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "members" ADD CONSTRAINT "FK_1784a83dc5192e284e5e16f208b" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD CONSTRAINT "FK_5bbd4c8222ea06add9df7e64867" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens" DROP CONSTRAINT "FK_5bbd4c8222ea06add9df7e64867"`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "members" DROP CONSTRAINT "FK_1784a83dc5192e284e5e16f208b"`,
    )
